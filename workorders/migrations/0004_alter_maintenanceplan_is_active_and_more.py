...
class Migration(migrations.Migration):
    ...
    dependencies = [
        (
            "workorders",
            "0003_maintenancecategory_alter_maintenanceplan_grace_km_and_more",
        ),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.BooleanField(
                default=True,
                help_text="Plan 'dormido' hasta cerrar primera OT Preventiva",
                verbose_name="Activo",
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ("KM_TIME", "Kilometraje (respaldo por tiempo)"),
        ...
        migrations.AlterField(
            ...
            name="threshold_days",
            field=models.PositiveIntegerField(
                default=180, verbose_name="Umbral Tiempo (días)"
            ),
        ),
        migrations.AlterField(
            model_name="maintenanceplan",
            name="threshold_km",
            field=models.PositiveIntegerField(
                default=10000, verbose_name="Umbral Kilometraje (km)"
            ),
        ),
        migrations.AlterField(
            ...
            field=models.DateTimeField(
                blank=True, null=True, verbose_name="Ingreso Real"
            ),
        ),
        migrations.AlterField(
            model_name="workorder",
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("STOPPED_BY_CLIENT", "Detenida Cliente"),
