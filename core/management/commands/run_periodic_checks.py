...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        self.stdout.write(
            self.style.SUCCESS(f"[{timezone.now()}] Iniciando Tareas Programadas...")
        )
        self.seed_maintenance_manuals()
        self.check_document_expirations()
        self.recalculate_maintenance_plans()
        self.stdout.write(
            self.style.SUCCESS(f"[{timezone.now()}] Tareas Programadas completadas.")
        )
    ...
    def check_document_expirations(self):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Verificación de documentos completada. {alerts_created} nuevas alertas generadas."
            )
        )
    ...
    def recalculate_maintenance_plans(self):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Recálculo de planes completado. {alerts_created} nuevas alertas generadas."
            )
        )
