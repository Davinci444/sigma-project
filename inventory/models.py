...
class Part(models.Model):
    ...
    stock_current = models.DecimalField(
        "Stock Actual", max_digits=10, decimal_places=2, default=0.0
    )
    stock_min = models.DecimalField(
        "Stock Mínimo", max_digits=10, decimal_places=2, default=1.0
    )
    average_cost = models.DecimalField(
        "Costo Promedio", max_digits=10, decimal_places=2, default=0.0
    )
