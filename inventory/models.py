...
class Part(models.Model):
    ...
    # --- NUEVO CAMPO ---
    unit = models.CharField("Unidad de Medida", max_length=20, choices=UnitOfMeasure.choices, default=UnitOfMeasure.UNIT)
    ...
    class Meta: verbose_name = "Repuesto"; verbose_name_plural = "Repuestos"

class InventoryMovement(models.Model):
    # ... (sin cambios)
    class MovementType(models.TextChoices): INBOUND = 'INBOUND', 'Entrada'; OUTBOUND = 'OUTBOUND', 'Salida'; ADJUSTMENT = 'ADJUSTMENT', 'Ajuste'
    ...
    def __str__(self): return f"{self.movement_type} de {self.quantity} x {self.part.sku}"
    class Meta: verbose_name = "Movimiento de Inventario"; verbose_name_plural = "Movimientos de Inventario"
