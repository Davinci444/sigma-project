"""Models for managing fleet vehicles and their history."""
...
class Vehicle(models.Model):
    ...
    vehicle_type = models.CharField(
        "Tipo de Vehículo", max_length=50, help_text="Ej: Camioneta, Bus, Automovil"
    )
    ...
    status = models.CharField(
        "Estado", max_length=20, choices=VehicleStatus.choices, default=VehicleStatus.ACTIVE
    )

    current_zone = models.ForeignKey(
        Zone, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Zona Operativa Actual"
    )
    ...
    odometer_status = models.CharField(
        "Estado del Odómetro",
        max_length=20,
        choices=OdometerStatus.choices,
        default=OdometerStatus.VALID,
    )
    ...
    def __str__(self) -> str:
        """Return a readable representation of the vehicle."""
...
class VehicleZoneHistory(models.Model):
    ...
    def __str__(self) -> str:
        """Return a readable representation of the zone history."""
